    ...
    <body>
      ...
      if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          $productImage = $row['c_image'];
      ?>
                    <div class="product-item">
                        <img src="../Admin/assets/images/<?php echo $productImage; ?>"
                            alt="<?php echo $productName; ?>">
                        <h4><?php echo $productName; ?></h4>
                        <a href="./category_cart.php?id=<?php echo $row['id']?>&name=<?php echo $row['name']?>" class="btn text-light rounded-pill" style="background-color: #e29338;">
                        Add To Cart
                    </a>
                    </div>
                    <?php
